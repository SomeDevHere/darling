...
#ifndef __ANDROID_STRINGS_H
#define __ANDROID_STRINGS_H
#include_next <strings.h>
#include <string.h>
#if defined (__ANDROID__)

#ifndef __ANDROID_STRING // to avoid issues if both string.h and strings.h are included
#define __ANDROID_STRING
...
#endif /* __ANDORID_STRING */

#endif /* __ANDROID__ */
#endif /* __ANDROID_STRINGS_H */
